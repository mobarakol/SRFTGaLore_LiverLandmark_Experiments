...
from models.model import model, Edge_Prototypes
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_galore_v4_64.pth")
            print("save best model at", save_path + "best_model_path_v15_galore_v4_64.pth")
