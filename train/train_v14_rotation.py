...
from utils.dataset_rotation import LandmarkDataset
from models.D2GP_v14 import D2GPLand, Edge_Prototypes


print ("v_14, add rotation s") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v14_rotation.pth")
            print("save best model at", save_path + "best_model_path_v14_rotation.pth")
