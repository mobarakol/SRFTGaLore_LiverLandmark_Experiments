...
print ("Replace the depth using DA2 encoder based on v_10, change CA ") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v14.pth")
            # torch.save(edge_prototypes_model.state_dict(), save_path + "best_prototype_path_v9.pth")
            print("save best model at", save_path + "best_model_path_v14.pth")
