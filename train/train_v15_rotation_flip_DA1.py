...
from models.D2GP_v15_DA1 import D2GPLand, Edge_Prototypes
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_rot_flip_DA1.pth")
            print("save best model at", save_path + "best_model_path_v15_rot_flip_DA1.pth")
