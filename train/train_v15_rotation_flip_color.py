...
from utils.dataset_rotation_flip_color import LandmarkDataset
from models.D2GP_v15 import D2GPLand, Edge_Prototypes


print ("v15, add rotation, flip, color, lr: 5e-5") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_rot_flip_color_28.pth")
            print("save best model at", save_path + "best_model_path_v15_rot_flip_color_28.pth")
