...
print ("v15, add rotation, lr: 5e-5") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_flip.pth")
            print("save best model at", save_path + "best_model_path_v15_flip.pth")
