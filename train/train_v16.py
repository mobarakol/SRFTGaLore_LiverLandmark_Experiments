...
from models.D2GP_v16 import D2GPLand, Edge_Prototypes


print ("v16 dora, CA v1, sam2 decoder") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v16.pth")
            print("save best model at", save_path + "best_model_path_v16.pth")
