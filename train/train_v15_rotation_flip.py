...
from models.D2GP_v15_CA_v2 import D2GPLand, Edge_Prototypes

from fvcore.nn import FlopCountAnalysis


print ("v15 lora, gated, add rotation and flip, lr: 5e-5, rank 7") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_CA_v2_again.pth")
            print("save best model at", save_path + "best_model_path_v15_CA_v2_again.pth")
