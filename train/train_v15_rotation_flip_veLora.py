...
from models.D2GP_v15_veLora import D2GPLand, Edge_Prototypes


print ("v15 veLora, CA v1, add rotation and flip, lr: 5e-5") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v15_veLora_r4.pth")
            print("save best model at", save_path + "best_model_path_v15_veLora_r4.pth")
