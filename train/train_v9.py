...
from models.D2GP_v9 import D2GPLand, Edge_Prototypes


print ("D2GP using Cross Attention, SAM_SAM and skip DPE and Geometric augmentation") 
...
def main(save_path, args):
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            torch.save(model.state_dict(), save_path + "best_model_path_v99.pth")
            # torch.save(edge_prototypes_model.state_dict(), save_path + "best_prototype_path_v9.pth")
            print("save best model at", save_path + "best_model_path_v99.pth")
