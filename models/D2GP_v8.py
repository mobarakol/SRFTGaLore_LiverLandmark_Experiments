# D2GP using Cross Attention and skip DPE and Geometric augmentation and remove interpolation
import math
import warnings
import torch
...
class D2GPLand(nn.Module):
    ...
    # def forward(self, image, depth, prototypes):
        ...
        # 1024×1024 depth → first_conv → SAM  → original_depth:[1,256,64,64]
        ...
        # out shape: [1, 512, 32, 32], depth_feat shape: [1, 256, 32, 32]
        out = self.fuse_model(out, depth_feat) # [4, 512, 32, 32]
