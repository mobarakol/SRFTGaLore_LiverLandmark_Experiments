...
class Decoder(nn.Module):
    ...
    def forward(self, enc_outs):
        ...
        # print("enc_out shape:", enc_out.shape, "enc_skip_down_16 shape:", enc_skip_down_16.shape)
...
class DecoderModule(nn.Module):
    ...
    def forward(self, decoder_features, encoder_features):
        ...
        if self.encoder_decoder_fusion == 'add':
            # out shape: [4, 256, 128, 128], encoder_features shape: [4, 256, 64, 64]
            # out shape without upsampling: [4, 256, 64, 64], encoder_features shape: [4, 256, 64, 64]
            # print("out shape:", out.shape, "encoder_features shape:", encoder_features.shape) 
