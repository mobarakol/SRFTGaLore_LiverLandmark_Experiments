# Replace the depth using DA2 encoder based on v_10, swap CA
import math
import warnings
import torch
...
class D2GPLand(nn.Module):
    ...
    def forward(self, image, depth):
        ...
        # print('SAM encoder output shape:', out.shape)
        # print('SAM skip1 shape:', skip1.shape)
        # print('SAM skip2 shape:', skip2.shape)
        # print('SAM skip3 shape:', skip3.shape)
       
        # ----- Cross Attention Fusion ------
        out = self.fuse_model(depth_feat, out) # [4, 256, 64, 64]
